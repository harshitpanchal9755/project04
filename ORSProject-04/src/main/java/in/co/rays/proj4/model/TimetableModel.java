...
public class TimetableModel {
	...
	public long add(TimetableBean bean) throws ApplicationException, DuplicateException {
		Connection conn = null;
		int pk = 0;
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in add Timetable" + e.getMessage());
		} finally {
			JdbcDataSource.closeConnection(conn);
		}
		return pk;
	...
	public void update(TimetableBean bean) throws ApplicationException, DuplicateException {
		...
		try {
			...
			throw new ApplicationException("Exception in updating Timetable " + e.getMessage());
		} finally {
			JdbcDataSource.closeConnection(conn);
		}
	}
